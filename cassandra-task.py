...
session.execute("INSERT INTO students (department, student_id, name, age, grade) VALUES ('IS', 1, 'Ahmed', 21, 3.8)")
session.execute("INSERT INTO students (department, student_id, name, age, grade) VALUES ('IS', 2, 'Ola', 20, 3.3)")
session.execute("INSERT INTO students (department, student_id, name, age, grade) VALUES ('IS', 3, 'Eman', 21, 2.5)")
